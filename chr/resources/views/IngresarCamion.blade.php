...
<body>
    ...
    <form class="form-group" method="POST" action="/camiones">
    @csrf
     <div class="container">
        Matrícula
        <div class="input-group mb-3">  
              <input type="text" class="form-control" name="mat" placeholder="Número de licencia" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        
        Tcp
        <div class="input-group mb-3">  
              <input type="text" class="form-control" name="tcp" placeholder="Clase de licencia" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        Std
        <div class="input-group mb-3">  
              <input type="text" class="form-control" name="std" placeholder="Municipalidad de licencia" aria-label="Username" aria-describedby="basic-addon1">
        </div>

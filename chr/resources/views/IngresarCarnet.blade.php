...
<body>
    ...
    <form class="form-group" method="POST" action="/carnets">
    @csrf
     <div class="container">
        Tipo
        <div class="input-group mb-3">  
              <input type="text" class="form-control" name="tipo" placeholder="Tipoe" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        Vencimiento
        <div class="input-group mb-3">  
